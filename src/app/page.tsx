...
<section className="container mx-auto py-32">
 ...
 <h3 className="font-bold text-xl">Category 1</h3>
  <img src="/jwell8.jpg" alt="slow net" className="h-60 w-80"/>
  ...
  <div className="bg-gray-100 p-6 text-center">
   ...
   <img src="/img9.jpg" alt="slow net" className="h-60 w-80" />
...
<div className="bg-gray-100 p-6 text-center">
     <h3 className="font-bold text-xl h-14">Category 3</h3>
        <img src="/jwell2.jpg" alt="slow net" className="h-60 w-80" />
