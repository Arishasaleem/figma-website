    ...
    <Head>
     ...
     <section className="bg-gray-100 py-16">
        <div className="container mx-auto text-center">
          ...
          <p className="text-lg text-gray-700 max-w-2xl mx-auto mb-8">
            We take pride in our commitment to quality, offering a range of jewelry that celebrates life's special moments.
            Whether you're looking for a symbol of love, a style statement, or a treasured keepsake, we're here to help.
          </p>
        </div>
      </section>
